...
const EcommerceAndRetailMerchants = () => {
  ...
  const handleUpdateBankAndNBFI = (data) => {
  ...
  return (
    <>
      <RtCard title={'Ecommerce & Retail Merchants'}>
        <IndustriesPageForm onSubmit={handleUpdateBankAndNBFI} />
      </RtCard>
    </>
  );
};

export default EcommerceAndRetailMerchants;
