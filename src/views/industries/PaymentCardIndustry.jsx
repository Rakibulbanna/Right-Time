...
const PaymentCardIndustry = () => {
  ...
  const handleUpdatePaymentBankIndustry = (data) => {
  ...
  return (
    <>
      <RtCard title={'Bank & NBFI'}>
        <IndustriesPageForm onSubmit={handleUpdatePaymentBankIndustry} />
      </RtCard>
    </>
  );
};

export default PaymentCardIndustry;
