...
const AddAuditingService = () => {
  ...
  useEffect(() => {
    if (id) {
      axios
        .get(`${process.env.REACT_APP_API_URL}/services/auditing/${id}`)
  ...
  const handleAddService = (data) => {
    ...
    if(id) {
      axios
      .put(`${process.env.REACT_APP_API_URL}/services/auditing/${id}`, formData)
      .then((res) => {
        toast.success('Auditing service updated successfully!')
        navigate('/services')
      })
      .catch((error) =>{
        console.log(error)
      ...
      axios
        .post(`${process.env.REACT_APP_API_URL}/services/addAuditing/`, formData)
        .then((res) => {
          toast.success('Auditing service added successfully!')
          navigate('/services')
        })
        .catch((error) =>{
          console.log(error)
  ...
  return (
    <RtCard title={`${id ? 'Edit' : 'Add'} Auditing Service`}>
      <PartnerPageForm
        form='training'
        data={data}
...
export default AddAuditingService;
